            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        {{-- <span class="text-white"><a href="{{url('auth/posts')}}" class="text-white">Posts</a></span> --}}
                        <h1 class="text-capitalize mb-4 text-lg">Blog articles</h1>
                        <ul class="list-inline">
                            <li class="list-inline-item"><a href="{{ url('auth/posts') }}" class="text-white">Posts</a></li>
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item text-white-50"><a href="{{ url('dashboard') }}"
    ...
    <section class="section blog-wrap bg-gray">
                                ...
                                <div class="blog-item-content bg-white p-5">
                                    <div class="blog-item-meta bg-gray pt-2 pb-1 px-3">
                                        <span class="text-muted text-capitalize d-inline-block mr-3"><i
                                                class="ti-comment mr-2"></i>{{ $blog->comments ? count($blog->comments) : 0 }}
                                            Comments</span>
        ...
        @else
            <div style="text-align: center;">
                <h3 style="color:red">No Post Record Found.</h3>
            </div>
            @endif
        </div>
        </div>
